...
const Calculator = {
    ...
    First_Operand: null,
    //This checks wether or not the second operand had been inputted by the user.
...
function Input_Digit(digit) {
    ...
    //This checks if the Wait_Secind_Operand is ture and sets Display_Value
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        ...
        //we want to add a decmial point.
